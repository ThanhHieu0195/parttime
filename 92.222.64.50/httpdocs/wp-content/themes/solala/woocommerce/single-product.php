...
<div class="slz-main-content padding-top-100 padding-bottom-100">
	<div class="container">
		<div class="slz-blog-detail <?php echo esc_attr( $solala_container['sidebar_layout_class'] ); ?>">
			<div class="row slz-woocommerce">
				...
				<div id='page-sidebar' class="slz-sidebar-column slz-widgets sidebar sidebar-widget <?php echo esc_attr( $solala_container['sidebar_class'] ); ?>">
